  ...
  return (
    <React.Fragment>
      <Container
        ...
        fluid
        style={{
          background: `linear-gradient(to left, rgba(8,15,23,0.9), rgba(38,44,47,0.99)),
        ...
        <Container className="py-5">
          <Row>
            ...
            <Col>
              <h1>
                {name}{' '}
                <span className="h2 text-secondary">({date.slice(0, 4)})</span>
              </h1>
              ...
              <Row>
                {json.created_by &&
                  json.created_by.map((elem, i) => (
                    <Col key={i} md={3}>
                      <strong>{elem.name}</strong>
                      <p className="text-secondary">creator</p>
                    </Col>
                  ))}
              </Row>
            </Col>
